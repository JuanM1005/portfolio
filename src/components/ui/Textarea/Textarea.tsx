...
export const Textarea = ({
    ...
    return (
        <div className={clsx('flex flex-col gap-1', fullWidth && 'w-full')}>
            <label htmlFor={textareaId} className='font-mono text-[11px] font-medium uppercase text-ink-soft/80 transition-colors peer-focus:text-burgundy-500'>
                {label}
            </label>
            ...
            <textarea
                ...
                className={clsx(
                    ...
                    error && 'border-red-500 focus-visible:border-red-500 focus-visible:ring-red-500/40',
                    className,
                )}
